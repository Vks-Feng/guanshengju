...
export class InfiniteGridClass {
   ...
   * ```
   */
  constructor(containerElement, cardData = [], options = {}) {
    if (!containerElement) {
  ...
  setupPostProcessing() {
    ...
    this.postProcessShader = new CustomPostProcessShader(
      this.renderer.gl, // Type assertion needed for OGL context
  ...
  animateInertiaScroll(vx = "auto", vy = "auto") {
