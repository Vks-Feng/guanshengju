 ...
 * ```
 */
export async function generateForegroundTexture(data, renderer) {
 ...
 * ```
 */
export async function generateBackgroundTexture(data, renderer) {
  const { canvas, ctx } = createCanvasContext();
 ...
 * ```
 */
export async function generateCardTextures(data, renderer) {
