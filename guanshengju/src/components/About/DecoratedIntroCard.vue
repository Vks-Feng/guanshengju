<template>
  <!-- 主容器：必须是 relative 且有明确的高度或 min-h-screen -->
  <section class="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
